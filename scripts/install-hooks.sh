...
echo "  • pre-commit: Runs formatting and linting for Rust, Go, and TypeScript"
echo ""
echo "📋 What the pre-commit hook does:"
echo "  • Rust: Runs 'cargo fmt --all' to format all Rust files"
echo "  • Go: Runs 'go fmt', 'go vet', and 'golangci-lint' (if installed)"
echo "  • TypeScript: Runs ESLint, Prettier, and type checking on payloads/"
...
echo "  • The second commit will succeed (assuming no new issues)"
echo ""
echo "⚠️  The hook will abort commits if formatting changes files or linting fails!"
