use crate::util::testutil::{
    discover_openai_chat_completion_test_cases, discover_openai_responses_test_cases,
    discover_test_cases, Provider,
};
...
mod tests {
    ...
    #[test]
    fn test_discover_openai_chat_completions_cases_untyped() {
