...
pub struct CreateResponseClass {
    ...
    /// prepended to `input_items` for this response request.
...
pub struct InputItem {
    ...
    pub summary: Option<Vec<SummaryElement>>,
...
pub struct Reasoning {
    ...
    pub generate_summary: Option<GenerateSummaryEnum>,
    /// A summary of the reasoning performed by the model. This can be
    /// useful for debugging and understanding the model's reasoning process.
    /// One of `auto`, `concise`, or `detailed`.
    pub summary: Option<GenerateSummaryEnum>,
}
...
pub struct TheResponseObject {
    ...
    /// response will not be carried over to the next response. This makes it simple
    /// to swap out system (or developer) messages in new responses.
    pub instructions: InstructionsUnion,
