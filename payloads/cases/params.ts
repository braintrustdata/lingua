...
export const paramsCases: TestCaseCollection = {
  ...
  responsesToolSearchStringArgumentsParam: {
    "chat-completions": null,
    responses: {
      model: "gpt-5.5",
      input: [
        {
          type: "message",
          role: "user",
          content: "Find weather tools.",
        },
        {
          type: "tool_search_call",
          call_id: "call_tool_search_string_args",
          status: "completed",
          execution: "client",
        ...
        },
        {
          type: "message",
          role: "user",
          content: "Continue from the preserved tool search call.",
        },
      ],
      tools: [
        {
  ...
  responsesNamespaceDuplicateLocalToolParam: {
    "chat-completions": null,
    responses: {
      model: "gpt-5.5",
      input: [
        {
          type: "message",
          role: "user",
          content: "Find lookup tools across namespaces.",
        },
      ],
      tools: [
        {
          type: "namespace",
          name: "crm",
          description: "Deferred CRM lookup tools.",
          tools: [
            {
              type: "function",
              name: "lookup",
        ...
        },
        {
          type: "namespace",
          name: "erp",
          description: "Deferred ERP lookup tools.",
          tools: [
            {
              type: "function",
              name: "lookup",
