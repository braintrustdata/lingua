...
export const paramsCases: TestCaseCollection = {
  ...
  googleResponseJsonSchemaPrefixItemsParam: {
    "chat-completions": {
      model: OPENAI_CHAT_COMPLETIONS_MODEL,
      messages: [
  ...
  googleResponseSchemaFormatParam: {
    "chat-completions": {
      model: OPENAI_CHAT_COMPLETIONS_MODEL,
      messages: [
        {
  ...
  googleResponseJsonSchemaMinMaxItemsParam: {
    "chat-completions": {
      model: OPENAI_CHAT_COMPLETIONS_MODEL,
      messages: [
        {
  ...
  googleResponseJsonSchemaMinimumMaximumParam: {
    "chat-completions": {
      model: OPENAI_CHAT_COMPLETIONS_MODEL,
      messages: [
        {
