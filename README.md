...
* Carefully designed types (see [message.rs](src/universal/message.rs)) that represent the ideal abstractions for working with LLMs and traits for translating between them
