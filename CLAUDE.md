...
Instead of executing ./scripts/generate-types.rs directly, always generate provider types from specs via the `generate-provider-types` Makefile target, e.g. `make generate-provider-types PROVIDER=openai`.
