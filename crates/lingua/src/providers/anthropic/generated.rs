...
pub struct CreateMessageParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub container: Option<ContainerUnion>,
...
pub struct SourceSource {
    ...
    pub data: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub media_type: Option<SourceSourceMediaType>,
    #[serde(rename = "type")]
    pub source_type: SourceSourceType,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub file_id: Option<String>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, TS)]
#[ts(export_to = "anthropic/")]
pub enum SourceSourceMediaType {
...
pub struct RequestCodeExecutionOutputBlock {
    pub file_id: String,
    #[serde(rename = "type")]
    pub request_code_execution_output_block_type: RequestCodeExecutionOutputBlockType,
}

#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, TS)]
#[serde(rename_all = "snake_case")]
#[ts(export_to = "anthropic/")]
pub enum RequestCodeExecutionOutputBlockType {
...
pub struct RequestDocumentBlockSource {
    ...
    pub data: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub media_type: Option<RequestDocumentBlockSourceMediaType>,
    #[serde(rename = "type")]
    pub source_type: Base64ImageSourceType,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub content: Option<Base64ImageSourceContent>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, TS)]
#[ts(export_to = "anthropic/")]
pub enum RequestDocumentBlockSourceMediaType {
    #[serde(rename = "application/pdf")]
    ApplicationPdf,
    #[serde(rename = "text/plain")]
    TextPlain,
...
pub struct ResponseWebSearchResultBlock {
    ...
    pub title: String,
    #[serde(rename = "type")]
    pub response_web_search_result_block_type: ResponseWebSearchResultBlockType,
    pub url: String,
}
...
#[serde(rename_all = "snake_case")]
#[ts(export_to = "anthropic/")]
pub enum ResponseWebSearchResultBlockType {
    #[serde(rename = "web_search_result")]
    WebSearchResult,
}
...
pub struct ResponseCodeExecutionOutputBlock {
    pub file_id: String,
    #[serde(rename = "type")]
    pub response_code_execution_output_block_type: RequestCodeExecutionOutputBlockType,
}
...
pub struct ResponseDocumentBlockSource {
    pub data: String,
    pub media_type: RequestDocumentBlockSourceMediaType,
    #[serde(rename = "type")]
    pub source_type: ResponseDocumentBlockSourceType,
}

#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, TS)]
#[serde(rename_all = "snake_case")]
#[ts(export_to = "anthropic/")]
pub enum ResponseDocumentBlockSourceType {
    Base64,
    Text,
}
