...
pub struct Part {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub speech_metadata: Option<SpeechMetadata>,
    /// Inline text.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct VoiceConfig {
    ...
    /// Optional. The speaker identifier for synthesis. Supported formats: * Speaker name for
    /// prebuilt voices (for example, `Orus` or `Kore`). * Voice ID for stored voices (for
    /// example, `voice_xxx`). * Voice replication key (for example, `voicekey_xxx`).
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// Optional. Enables the model to execute code as part of generation.
///
/// Tool that executes code generated by the model, and automatically returns the result to
/// the model. See also `ExecutableCode` and `CodeExecutionResult` which are only generated
